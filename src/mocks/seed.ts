...
export const services: Service[] = [
  {
    ...
    name: "Corte de pelo",
    description: "Lavado, corte a tijera o máquina y peinado. Incluye asesoramiento de estilo.",
    imageKeys: [],
    durationMinutes: 30,
    priceCents: 800000,
    allowNoPayment: true,
  ...
  },
  {
    ...
    membershipId: MEMBERSHIP_ID,
    name: "Corte + barba",
    description: "Corte completo más perfilado y arreglo de barba con toalla caliente.",
    imageKeys: [],
    durationMinutes: 45,
    priceCents: 1200000,
    allowNoPayment: true,
...
export function buildPublicServices(): PublicServiceDto[] {
  return services
    ...
    .map((s) => ({
      ...
      // En real son URLs firmadas; el seed no tiene imágenes cargadas.
      imageUrls: [],
